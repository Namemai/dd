                            ...
                            if msg._from in admin or msg._from in owner:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k1.sendMessage(msg.to, "มุดแล้วค่ะ.. : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k2.sendMessage(msg.to, "มุดแล้วค่ะ.. : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k3.sendMessage(msg.to, "มุดแล้วค่ะ.. : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k4.sendMessage(msg.to, "มุดแล้วค่ะ.. : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k5.sendMessage(msg.to, "มุดแล้วค่ะ.. : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k6.sendMessage(msg.to, "มุดแล้วค่ะ.. : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k7.sendMessage(msg.to, "มุดแล้วค่ะ.. : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k8.sendMessage(msg.to, "มุดแล้วค่ะ.. : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k9.sendMessage(msg.to, "มุดแล้วค่ะ.. : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k10.sendMessage(msg.to, "มุดแล้วค่ะ.. : %s" % str(group.name))
