...
k2 = LINE("EQtBjlsLhyYE3AhQtVUd.ARAzAuWFaouOQmcAei0odq.HJtHiHbQTiMoJC/IQdXVoCXxoN80CqDZSw/VJkNpBo0=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist2 Login ]\033[0m"""%(Bot_startTime))

k3 = LINE("EQlrHDNONo2uy9Rvm3f6.68J8xVmSlAPaErf1HvBFXG.v+BwNyRqWp8KdVWi35pVaJVcQmk+VC8uJxwaDlqozAE=")
...
k7 = LINE("EQUUQ7hWYGWF9X5Diyy5.4gYxzyl3lm5uONmZ4iMHnq.sPJkAQ6wOmLlHTyUNfC7wVuvWUusC7WHB5pU+2rGt6A=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist7 Login ]\033[0m"""%(Bot_startTime))

k8 = LINE("EQ2DoycLpmmDH0MvqEB1.Vd51EsbGLagJVzohYWYO8q.Rn4msvc7ixENO3eileby1XU/7vtCBpIMoEcB5Fj99R8=")
print("""\033["""+str(randint(0,1))+""";"""+str(randint(31,36))+"""m[ %s Asist8 Login ]\033[0m"""%(Bot_startTime))

k9 = LINE("EQaHUPCSERufjvLxDtj7.1uudGFE4NtUXNTbuXfQ7nW.JSMHRT2T5/OUx84FROeL35LgKPyHMltF46V6XPyd/fU=")
...
oepoll = OEPoll(cl)
call = cl
creator = ["u6db4e76a906e12763340d607557ae69e","u02b175e62fb53fd8547e712148e1d510"]
owner = ["u6db4e76a906e12763340d607557ae69e","u02b175e62fb53fd8547e712148e1d510"]
admin = ["u6db4e76a906e12763340d607557ae69e","u02b175e62fb53fd8547e712148e1d510"]
staff = ["u6db4e76a906e12763340d607557ae69e","u02b175e62fb53fd8547e712148e1d510"]
#==============================================================================
...
KAC = [k1,k2,k3,k4,k5,k6,k7,k8,k9,k10,g1]
ABC = [k1,k2,k3,k4,k5,k6,k7,k8,k9,k10,g1]
KICKER = [g1]           
        ...
        if op.type == 19:
            if mid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        g1.acceptGroupInvitation(op.param1)
                        g1.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid])
                        cl.acceptGroupInvitation(op.param1)
                        k1.acceptGroupInvitation(op.param1)
                        k2.acceptGroupInvitation(op.param1)
                        k3.acceptGroupInvitation(op.param1)
                        ...
                        k9.acceptGroupInvitation(op.param1)
                        k10.acceptGroupInvitation(op.param1)
                        group = g1.getGroup(op.param1)
                        group.preventedJoinByTicket = False
                        g1.updateGroup(group)
                        invsend = 0
        ...
        if op.type == 19:
            ...
            if Amid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        k2.kickoutFromGroup(op.param1,[op.param2])
                        k2.inviteIntoGroup(op.param1,[Amid,mid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid])
                        k1.acceptGroupInvitation(op.param1)
                        cl.acceptGroupInvitation(op.param1)
                        k3.acceptGroupInvitation(op.param1)
                        k4.acceptGroupInvitation(op.param1)
                        ...
                        try:
                            k3.kickoutFromGroup(op.param1,[op.param2])
                            k3.inviteIntoGroup(op.param1,[Amid,Bmid,mid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid])
                            k1.acceptGroupInvitation(op.param1)
                            k2.acceptGroupInvitation(op.param1)
                            cl.acceptGroupInvitation(op.param1)
                            k4.acceptGroupInvitation(op.param1)
                            ...
                            try:
                                k4.kickoutFromGroup(op.param1,[op.param2])
                                k4.inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,mid,Emid,Fmid,Gmid,Hmid,Imid,Jmid])
                                k1.acceptGroupInvitation(op.param1)
                                k2.acceptGroupInvitation(op.param1)
                                k3.acceptGroupInvitation(op.param1)
                                cl.acceptGroupInvitation(op.param1)
                                ...
                                try:
                                    k5.kickoutFromGroup(op.param1,[op.param2])
                                    k5.inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,Dmid,mid,Fmid,Gmid,Hmid,Imid,Jmid])
                                    k1.acceptGroupInvitation(op.param1)
                                    k2.acceptGroupInvitation(op.param1)
                                    k3.acceptGroupInvitation(op.param1)
                                    k4.acceptGroupInvitation(op.param1)
                                    ...
                                    try:
                                        k6.kickoutFromGroup(op.param1,[op.param2])
                                        k6.inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,Dmid,Emid,mid,Gmid,Hmid,Imid,Jmid])
                                        k1.acceptGroupInvitation(op.param1)
                                        k2.acceptGroupInvitation(op.param1)
                                        k3.acceptGroupInvitation(op.param1)
                                        k4.acceptGroupInvitation(op.param1)
                                        ...
                                        try:
                                            k7.kickoutFromGroup(op.param1,[op.param2])
                                            k7.inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,Dmid,Emid,Fmid,mid,Hmid,Imid,Jmid])
                                            k1.acceptGroupInvitation(op.param1)
                                            k2.acceptGroupInvitation(op.param1)
                                            k3.acceptGroupInvitation(op.param1)
                                            k4.acceptGroupInvitation(op.param1)
                                            ...
                                            try:
                                                k8.kickoutFromGroup(op.param1,[op.param2])
                                                k8.inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,mid,Imid,Jmid])
                                                k1.acceptGroupInvitation(op.param1)
                                                k2.acceptGroupInvitation(op.param1)
                                                k3.acceptGroupInvitation(op.param1)
                                                k4.acceptGroupInvitation(op.param1)
                                                ...
                                                try:
                                                    k9.kickoutFromGroup(op.param1,[op.param2])
                                                    k9.inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,mid,Jmid])
                                                    k1.acceptGroupInvitation(op.param1)
                                                    k2.acceptGroupInvitation(op.param1)
                                                    k3.acceptGroupInvitation(op.param1)
                                                    k4.acceptGroupInvitation(op.param1)
                                                    ...
                                                    try:
                                                        k10.kickoutFromGroup(op.param1,[op.param2])
                                                        k10.inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,mid])
                                                        k1.acceptGroupInvitation(op.param1)
                                                        k2.acceptGroupInvitation(op.param1)
                                                        k3.acceptGroupInvitation(op.param1)
                                                        k4.acceptGroupInvitation(op.param1)
                                        ...
                                        try:
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        k1.kickoutFromGroup(op.param1,[op.param2])
                                                        k1.inviteIntoGroup(op.param1,[mid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid])
                                                        cl.acceptGroupInvitation(op.param1)
                                                        k2.acceptGroupInvitation(op.param1)
                                                        k3.acceptGroupInvitation(op.param1)
                                                        k4.acceptGroupInvitation(op.param1)
...
#===================================================================================================                      
        ...
        if op.type == 55:
            if op.param2 in bl["blacklist"]:
                ...
                random.choice(ABC).sendMessage(op.param1,"ติดดำถาวร")					
