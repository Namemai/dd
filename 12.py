...
g2 = LINE("gcu89366@zzrgg.com","mai065558mai")
...
KAC = [k1,k2,k3,k4,k5,k6,k7,k8,k9,k10,k11,k12]
ABC = [k1,k2,k3,k4,k5,k6,k7,k8,k9,k10,k11,k12]
KICKER = [g1,g2]           
Bots = [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid,g1MID,g2MID]
        ...
        if op.type == 13:
            if Fmid in op.param3:
                ...
                for taged in InviterX:
                    if taged in bl['blacklist']:
                        try:
                            k6.cancelGroupInvitation(op.param1,[op.param2])
                            k6.kickoutFromGroup(op.param1,[op.param2])
                            bl['blacklist'][op.param2] = True
                            with open('bl.json', 'w') as fp:
                                json.dump(bl, fp, sort_keys=True, indent=4)
                ...
                if mid in op.param3:
                    if op.param2 not in Bots and op.param2 not in Saint and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        try:
                            ...
                            group = random.choice(KICKER).getGroup(op.param1)
                            group.preventedJoinByTicket = False
                            random.choice(KICKER).updateGroup(group)
                            Ticket = random.choice(KICKER).reissueGroupTicket(op.param1)
        ...
        if op.type == 19:
            ...
            if Amid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        k2.kickoutFromGroup(op.param1,[op.param2])
                        k2.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid])
                        cl.acceptGroupInvitation(op.param1)
                        k1.acceptGroupInvitation(op.param1)
                        k2.acceptGroupInvitation(op.param1)
                        k3.acceptGroupInvitation(op.param1)
                        ...
                        try:
                            k3.kickoutFromGroup(op.param1,[op.param2])
                            k3.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid])
                            cl.acceptGroupInvitation(op.param1)
                            k1.acceptGroupInvitation(op.param1)
                            k2.acceptGroupInvitation(op.param1)
                            k3.acceptGroupInvitation(op.param1)
                            ...
                            try:
                                k4.kickoutFromGroup(op.param1,[op.param2])
                                k4.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid])
                                cl.acceptGroupInvitation(op.param1)
                                k1.acceptGroupInvitation(op.param1)
                                k2.acceptGroupInvitation(op.param1)
                                k3.acceptGroupInvitation(op.param1)
                                ...
                                try:
                                    k5.kickoutFromGroup(op.param1,[op.param2])
                                    k5.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Limd])
                                    cl.acceptGroupInvitation(op.param1)
                                    k1.acceptGroupInvitation(op.param1)
                                    k2.acceptGroupInvitation(op.param1)
                                    k3.acceptGroupInvitation(op.param1)
                                    ...
                                    try:
                                        k6.kickoutFromGroup(op.param1,[op.param2])
                                        k6.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Limd])
                                        cl.acceptGroupInvitation(op.param1)
                                        k1.acceptGroupInvitation(op.param1)
                                        k2.acceptGroupInvitation(op.param1)
                                        k3.acceptGroupInvitation(op.param1)
                                        ...
                                        try:
                                            k7.kickoutFromGroup(op.param1,[op.param2])
                                            k7.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid])
                                            cl.acceptGroupInvitation(op.param1)
                                            k1.acceptGroupInvitation(op.param1)
                                            k2.acceptGroupInvitation(op.param1)
                                            k3.acceptGroupInvitation(op.param1)
                                            ...
                                            try:
                                                k8.kickoutFromGroup(op.param1,[op.param2])
                                                k8.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid])
                                                cl.acceptGroupInvitation(op.param1)
                                                k1.acceptGroupInvitation(op.param1)
                                                k2.acceptGroupInvitation(op.param1)
                                                k3.acceptGroupInvitation(op.param1)
                                                ...
                                                try:
                                                    k9.kickoutFromGroup(op.param1,[op.param2])
                                                    k9.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid])
                                                    cl.acceptGroupInvitation(op.param1)
                                                    k1.acceptGroupInvitation(op.param1)
                                                    k2.acceptGroupInvitation(op.param1)
                                                    k3.acceptGroupInvitation(op.param1)
                                                    ...
                                                    try:
                                                        k10.kickoutFromGroup(op.param1,[op.param2])
                                                        k10.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid])
                                                        cl.acceptGroupInvitation(op.param1)
                                                        k1.acceptGroupInvitation(op.param1)
                                                        k2.acceptGroupInvitation(op.param1)
                                                        k3.acceptGroupInvitation(op.param1)
                                                        ...
                                                        try:
                                                            ...
                                                            random.choice(KAC).updateGroup(group)
                                                            invsend = 0
                                                            Ticket = random.choice(KBC).reissueGroupTicket(op.param1)
                                                            g1.acceptGroupInvitationByTicket(op.param1,Ticket)
                                                            g2.acceptGroupInvitationByTicket(op.param1,Ticket)
                                                            cl.acceptGroupInvitationByTicket(op.param1,Ticket)
                                                            k1.acceptGroupInvitationByTicket(op.param1,Ticket)
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                k5.kickoutFromGroup(op.param1,[op.param2])
                                k5.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid])
                                cl.acceptGroupInvitation(op.param1)
                                k1.acceptGroupInvitation(op.param1)
                                k2.acceptGroupInvitation(op.param1)
                                k3.acceptGroupInvitation(op.param1)
                                ...
                                try:
                                    k6.kickoutFromGroup(op.param1,[op.param2])
                                    k6.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid])
                                    cl.acceptGroupInvitation(op.param1)
                                    k1.acceptGroupInvitation(op.param1)
                                    k2.acceptGroupInvitation(op.param1)
                                    k3.acceptGroupInvitation(op.param1)
                                        ...
                                        try:
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        k11.kickoutFromGroup(op.param1,[op.param2])
                                                        k11.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid])
                                                        cl.acceptGroupInvitation(op.param1)
                                                        k1.acceptGroupInvitation(op.param1)
                                                        k2.acceptGroupInvitation(op.param1)
                                                        k3.acceptGroupInvitation(op.param1)
                                        ...
                                        try:
                                            ...
                                            try:                                                
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        k12.kickoutFromGroup(op.param1,[op.param2])
                                                        k12.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid])
                                                        cl.acceptGroupInvitation(op.param1)
                                                        k1.acceptGroupInvitation(op.param1)
                                                        k2.acceptGroupInvitation(op.param1)
                                                        k3.acceptGroupInvitation(op.param1)
                                        ...
                                        try:
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        k1.kickoutFromGroup(op.param1,[op.param2])
                                                        k1.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid])
                                                        cl.acceptGroupInvitation(op.param1)
                                                        k1.acceptGroupInvitation(op.param1)
                                                        k2.acceptGroupInvitation(op.param1)
                                                        k3.acceptGroupInvitation(op.param1)
                    ...
                    if text is None:
                        ...
                        if cmd == "on":
                          ...
                          if msg._from in admin:
                              ...
                              k11.sendMessage(msg.to,Kmid)   
                              k12.sendMessage(msg.to,Lmid)

                        elif cmd == "speedbot" or cmd == "spb":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(to, "สปีด..")
                               ...
                               elapsed_time = time.time() - start
                               k11.sendMessage(msg.to, "[ %s Seconds ] [ " % (elapsed_time) + str(int(round((time.time() - start) * 1000)))+" ms ]")
                               elapsed_time = time.time() - start       
                               k12.sendMessage(msg.to, "[ %s Seconds ] [ " % (elapsed_time) + str(int(round((time.time() - start) * 1000)))+" ms ]") 
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                               ...
                               saya = k11.getGroupIdsJoined()
                               saya = k12.getGroupIdsJoined()
                               for group in saya:
                                   ...
                                   k11.sendMessage(group,"\n" + str(pesan))
                                   k12.sendMessage(group,"\n" + str(pesan))
...
#===========BOT UPDATE============#
                         ...
                         if msg._from in admin:
                           if msg.toType == 2:
                               ...
                               time.sleep(0.01)
                               group = k12.getGroup(to)
                               group.preventedJoinByTicket = True
                               k12.updateGroup(group)
                        
                        elif cmd == "iv":
                          if wait["selfbot"] == True:
                            if msg._from in creator or msg._from in owner or msg._from in admin:
                                try:
                                    anggota = [Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid]
...
#===========COMMAND BLACKLIST============#
                               ...
                               for target in targets:
                                   if target not in Team:
                                       try:
                                           ...
                                           cl.sendMessage(msg.to,"Berhasil  blacklist")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in creator or msg._from in owner or msg._from in admin:
                              cl.sendMessage(msg.to,"Succes {} Blacklist".format(str(len(bl["blacklist"]))))
                              bl["blacklist"] = {}
...
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                            ...
                            if msg._from in admin or msg._from in owner:
                               ...
                               try:k11.inviteIntoGroup(to, [Kmid]);has = "OK"
                               except:has = "NOT"
                               try:k11.kickoutFromGroup(to, [Kmid]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "⭕"
                               else:sil = "⛔"
                               if has1 == "OK":sil1 = "⭕"
                               ...
                               try:k12.inviteIntoGroup(to, [Lmid]);has = "OK"
                               except:has = "NOT"
                               try:k12.kickoutFromGroup(to, [Lmid]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "⭕"
                               else:sil = "⛔"
                               if has1 == "OK":sil1 = "⭕"
                            ...
                            if msg._from in admin or msg._from in owner:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     cl.sendMessage(msg.to, "ɢᴏ : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k1.sendMessage(msg.to, "ɢᴏ : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k2.sendMessage(msg.to, "ɢᴏ : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k3.sendMessage(msg.to, "ɢᴏ : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k4.sendMessage(msg.to, "ɢᴏ : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k5.sendMessage(msg.to, "ɢᴏ : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k6.sendMessage(msg.to, "ɢᴏ : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k7.sendMessage(msg.to, "ɢᴏ : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k8.sendMessage(msg.to, "ɢᴏ : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k9.sendMessage(msg.to, "ɢᴏ : %s" % str(group.name))
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     k10.sendMessage(msg.to, "ɢᴏ : %s" % str(group.name))
